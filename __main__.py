...
import os, sys, argparse, configparser, shutil, subprocess, fnmatch
import os.path
...
short_calls = frozenset() if "short-calls" not in iniparser else frozenset(iniparser["short-calls"])
